...
public class JwtUtils {
     ...
     * @return 令牌
     */
    public String createJwt(UserDetails user, String username, String userId) {
     ...
     * 将jwt对象中的 自定义字段 提取出来
     * @param jwt 已解析的Jwt对象
     * @param column 自定义字段名称
     * @return 提取出来的值
     */
    public String toColumn(DecodedJWT jwt, String column) {
        Map<String, Claim> claims = jwt.getClaims();
        return claims.get(column).asString();
    }
